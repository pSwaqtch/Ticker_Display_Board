...
void printBoard(int w, int l,int speed,char newArray[10][printWidth]);
...
int main(){
    ...
    int length=strlen(newArray[0]), boardWidth=printWidth, speed, itteration;
    ...
    for (int i = 0; i < itteration; ++i) {
	   printBoard(boardWidth,length,speed,newArray);
    }
}
